...
public class Viewholder_Question extends RecyclerView.ViewHolder
{
   ...
   public TextView deletebtn, replybtn, replybtn1;
    ...
    public void setitem(FragmentActivity activity, String name,String url,String userid,String key,
    ...
    public void setitemRelated(Application activity, String name, String url, String userid, String key,
                               String question, String privacy, String time)
    {
